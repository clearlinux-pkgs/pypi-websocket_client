...
Source0  : https://files.pythonhosted.org/packages/8d/12/cd10d050f7714ccc675b486cdcbbaed54c782a5b77da2bb82e5c7b31fb40/websocket-client-1.3.1.tar.gz
...
%prep
%setup -q -n websocket-client-1.3.1
cd %{_builddir}/websocket-client-1.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645918419
