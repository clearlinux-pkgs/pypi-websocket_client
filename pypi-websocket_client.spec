...
Source0  : https://files.pythonhosted.org/packages/71/aa/69c635c6d209a3e67cfcaa0cf6d2de71cf7575347f63d5976c8792b8be2e/websocket-client-1.4.0.tar.gz
...
%prep
%setup -q -n websocket-client-1.4.0
cd %{_builddir}/websocket-client-1.4.0
pushd ..
cp -a websocket-client-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661382101
